...
class Affichage_Stat:
    ...
    def informations_seuil_inf(self,critere):
        ...
        """ Affiche les pays dont le critère dépasse un certain seuil
            Arguments:
                critère {str} -- Critère à récupérer
        """
    ...
    def informations_seuil_supp(self,critere):
        ...
        """ Affiche les pays dont le critère ne dépasse pas un certain seuil
            Arguments:
                critère {str} -- Critère à récupérer
        """
    ...
    def tableau_classe_age(self):
        ...
        """ Affiche le tableau des classes d’âge pour les pays désignés par l'utilisateur
        """
